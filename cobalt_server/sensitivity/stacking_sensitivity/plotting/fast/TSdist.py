...
alldata = '/data/user/brelethford/Output/fast/stacking_sensitivity/{}yr/{}/{}/'.format(years,catalog,weight)

bg_trials = cache.load(alldata+'trials.array')
sig_trials = cache.load(alldata+'sig/inj_trials.array')
