...
parser.add_option ('--fom', dest = 'fom',
                default = 0., metavar = 'FOM',
                help = 'Selects fomcut used for WHSP blazars')
...
for gamma in gammarange:
    commands.append('{0} {1} --cat {2} --llhweight {3} --injweight {4} --n {5} --gamma {6} --fom {7}'.format (env_shell, job_script, catalog, llhweight, injweight, n, gamma, fom))
