...
sens_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/{0}/bstacking_{1}yr/{2}/schatto79_{3}_inj/discovery/'.format(catalog,str(years),llhweight,injweight))
