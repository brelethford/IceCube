...
datafolder='/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/redshift/background_trials/'
...
results = PointSourceLLH.weighted_sensitivity(llh_redshift,src_ra=src_ra,src_dec=src_dec,alpha=.5,beta=.9,inj=inj,trials={'n_inj':[],'TS':[],'nsources':[],'gamma':[]},bckg_trials=bckg_trials,eps=0.01,n_iter=250)
print results

#choose an output dir, and make sure it exists
this_dir = os.path.dirname(os.path.abspath (__file__))
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/redshift/sensitivity/')

# save the output
outfile = out_dir + 'redshift_sensitivity.array'
