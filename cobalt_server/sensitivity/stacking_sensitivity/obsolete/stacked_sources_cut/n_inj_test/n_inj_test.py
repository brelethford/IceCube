...
def get_SwiftBAT_params():
    ...
    params={'ra':[ra[0]],'dec':[dec[0]],'redshift':[redshift[0]],'gamma':[gamma[0]],'flux':[flux[0]],'lum':[lum[0]]}
    return params

params = cache.get (datafolder + 'SwiftBAT70m/pickle/onesource.pickle', get_SwiftBAT_params)



###Now I'll read in the background TS stuff.###
datafolder='/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m_mc_cut/{}/background_trials/'.format(llhweight)
...
sens_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m_mc_cut/onesource/')
