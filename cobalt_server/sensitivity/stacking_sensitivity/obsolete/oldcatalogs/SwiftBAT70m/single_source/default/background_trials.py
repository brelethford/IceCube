...
llh_uniform = data_box.init(energy=True)
...
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/all_sky_sensitivity/results/single_stacked/default/dec{0:+010.5}/'.format(dec_deg))
