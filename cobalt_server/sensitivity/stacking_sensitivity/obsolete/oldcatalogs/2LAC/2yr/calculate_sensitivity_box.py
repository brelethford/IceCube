...
sens_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/2LAC/{0}/sensitivity/'.format(llhweight))
...
# save the output
outfile_sens = sens_dir + 'gamma{}_box.array'.format(Gamma)
