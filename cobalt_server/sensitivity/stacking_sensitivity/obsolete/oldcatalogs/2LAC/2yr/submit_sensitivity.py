...
# set up submitter
submitter = Submitter (job_dir='/data/user/brelethford/Output/stacking_sensitivity/2LAC/jobs/{}'.format (job_id))
...
for gamma in gammarange:
    commands.append('{0} {1} --llhweight {2} --gamma {3}'.format (env_shell, job_script, llhweight, gamma))
