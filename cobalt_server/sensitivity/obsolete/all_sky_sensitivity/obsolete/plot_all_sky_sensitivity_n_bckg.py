...
datafolder = '/data/user/brelethford/Output/all_sky_sensitivity/results/n_bckg/' ##Remember to change this depending on which results you're looking at!##
...
ax.set_title(r'Single Source Sensitivity - n_bckg')
ax.set_xlabel(r'$\sin{(\delta)}$')
ax.set_ylabel(r'$\Phi_{0}[\frac{1}{GeV cm^2 s}]$') 
ax.semilogy() 
plt.legend(loc='upper right')
fig_sensitivity.savefig('/data/user/brelethford/AGN_Core/Plots/single_source_sensitivity_n_bckg.pdf')
