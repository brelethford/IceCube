...
#Now we do the work...
sensitivity_array = sensitivity_skylab(src_dec=opts.dec, eps=0.001)

#choose an output dir, and make sure it exists
this_dir = os.path.dirname(os.path.abspath (__file__))
## NOTE: THE OUT DIRECTORY CHANGES DEPENDING ON WHICH SUBMITTER I'M TESTING!:
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/all_sky_sensitivity/results/eps_plus/')
