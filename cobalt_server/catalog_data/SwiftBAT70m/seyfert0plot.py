...
py.title(r"\textit{Swift}-BAT 70 month Seyfert Catalogue - Equatorial", fontsize = 25, fontweight='bold')
...
py.savefig('/data/user/brelethford/AGN_Core/Plots/equatorialmap.png')
...
py.title(r"\textit{Swift}-BAT 70 month Seyfert Catalogue - Galactic", fontsize = 25, fontweight = 'bold')
#hp.projscatter(0,0,coord='G',lonlat=True) # This one used to test GC
hp.projscatter(ra,dec, coord='C', lonlat=True, s = fluxplot)
...
py.savefig('/data/user/brelethford/AGN_Core/Plots/galacticmap.png')
