...
filename_plots=projfolder + 'AGN_Core/Plots/tests/sigma_error/sirin/'
...
def plot_error(year):
   ...
   # fig_energy.savefig(filename_plots + 'energy_hists_IC{}.pdf'.format(str(year)))
    ...
    fig_angular_error.savefig(filename_plots + 'angular_error_hists_sirin_IC{}.pdf'.format(str(year)))
...
def plot_ratio(year):
   ...
   # fig_energy.savefig(filename_plots + 'energy_hists_IC{}.pdf'.format(str(year)))
    ...
    fig_ratio.savefig(filename_plots + 'dpsi_sigma_ratio_IC{}_sirin.pdf'.format(str(year)))
