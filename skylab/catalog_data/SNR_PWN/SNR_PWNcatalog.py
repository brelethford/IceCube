...
filename =open('/home/brelethford/Documents/IceCube_Research/Scripts/AGN_Core/catalog_data/SNR_PWN/rawparams.txt','r')
...
cache.save(params, '/data/user/brelethford/Data/SNR_PWN/pickle/params.pickle')
