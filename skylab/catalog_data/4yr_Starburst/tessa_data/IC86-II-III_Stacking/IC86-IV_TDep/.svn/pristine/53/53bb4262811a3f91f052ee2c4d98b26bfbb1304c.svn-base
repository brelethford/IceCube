/*
 * special loadark to be used with TreeLoader_IC86_II_III_IV_lc_MESEremoved_DOUBLESremoved.C
 */

void load_ark_ic86_II_III_IV_tdep_lc_MESEremoved_DOUBLESremoved(I3Ark& ark, bool opt_UseRealData, TString RecoName) {
