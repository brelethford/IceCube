...
#Now let's seed these so that they are the same, each time. Then test.
np.random.seed(0)
...
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/{}/seedtest/{}/'.format(llhweight,batch))

# save the output
outfile = out_dir + 'seedtest_trials.array'
