...
datafolder='/data/user/brelethford/Output/stacking_sensitivity/2LAC/flux_{0}yr/background_trials/'.format(str(years))
...
sens_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/2LAC/flux_{0}yr/sensitivity/'.format(str(years)))
