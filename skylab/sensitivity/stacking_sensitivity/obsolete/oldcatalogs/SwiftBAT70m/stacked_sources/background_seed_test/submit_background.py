...
# set up submitter
submitter = Submitter (job_dir='/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/{0}/seedtest/jobs/{1}'.format (llhweight, job_id))
