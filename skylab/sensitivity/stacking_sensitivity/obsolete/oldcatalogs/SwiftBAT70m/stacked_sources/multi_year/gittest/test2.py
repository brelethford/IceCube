...
inj = StackingPointSourceInjector(Gamma, sinDec_bandwidth=.05, src_dec= src_dec, w_theo = modelweights['{}'.format(injweight)], seed=0) 

#I think I need an mc sample in this? But how do I get one for a multipointsourcellh?
sensitivity = StackingMultiPointSourceLLH.weighted_sensitivity(llhmodel,src_ra=src_ra,src_dec=src_dec,alpha=.5,beta=.9,inj=inj, w_theoMC=modelweights['{}'.format(llhweight)],bckg_trials=bckg_trials,eps=0.02,n_iter=250)
print sensitivity
