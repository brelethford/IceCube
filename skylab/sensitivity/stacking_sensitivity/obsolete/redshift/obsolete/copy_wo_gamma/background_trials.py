...
llh_redshift = datatest_stack_bins.init(energy=True, weighting = np.power(redshift,-2))
...
#
#
bckg_trials_redshift = PointSourceLLH.background_scrambles(llh_redshift,src_ra,src_dec,alpha=0.5,maxiter=batchsize)
#
...
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/redshift/background_trials/')

# save the output
outfile = out_dir + 'background_batch_{}.array'.format(batch)
print 'Saving', outfile, '...'
cache.save(bckg_trials_redshift, outfile)
