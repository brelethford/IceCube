...
datafolder_uniform = '/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/uniform/background_trials/'
datafolder_flux = '/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/flux/background_trials/'
datafolder_redshift = '/data/user/brelethford/Output/stacking_sensitivity/SwiftBAT70m/redshift/background_trials/'
...
ax.set_title(r'70m Background TS - 1yr')
ax.set_xlabel(r'TS')
...
fig_bckg.savefig('/data/user/brelethford/AGN_Core/Plots/backgroundTS/bckgTS_70m_1yr.pdf')
fig_bckg.savefig('/data/user/brelethford/AGN_Core/Plots/backgroundTS/bckgTS_70m_1yr.png')
