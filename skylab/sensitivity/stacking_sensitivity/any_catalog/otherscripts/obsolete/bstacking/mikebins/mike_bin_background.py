...
out_dir = misc.ensure_dir ('/data/user/brelethford/Output/stacking_sensitivity/{0}/bstacking_{1}yr/{2}/mike_background_trials/'.format(catalog,str(years),llhweight))
