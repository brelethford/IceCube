...
job_script = this_dir + '/mike_bin_background.py'
...
for i in range(batches):
    commands.append('{0} {1} --batch {2} --batchsize {3} --cat {4} --llhweight {5} --injweight {6} --years {7}'.format (env_shell, job_script, i, batchsize, catalog, llhweight, injweight, str(n)))
