...
if catalog:
    sensitivity = llh[0].weighted_sensitivity(src_ra=src_ra,src_dec=src_dec,alpha=alpha,beta=beta,inj=inj,TSval = TSval,src_w=modelweights['{}'.format(injweight)],eps=0.04,n_iter=100)
else:
    sensitivity = llh[0].weighted_sensitivity(src_ra=src_ra,src_dec=src_dec,alpha=alpha,beta=beta,inj=inj,TSval = TSval,eps=0.04,n_iter=100)
