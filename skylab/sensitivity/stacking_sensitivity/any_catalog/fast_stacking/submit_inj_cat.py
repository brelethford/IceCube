...
if catalog == 'Milagro17':
  ...
  nstep_sens = 2
  nstep_disc = 10
elif catalog in ['4yr_Starburst', 'blackhole']:
  n_sens_bounds = [0.,30.]
  n_disc_bounds = [30., 101.]
  nstep_sens = 3
  nstep_disc = 10
elif catalog == 'SwiftBAT70m':
  if n ==4: 
    n_sens_bounds = [0.,60.]
    n_disc_bounds = [60., 181.]
    nstep_sens = 4
    nstep_disc = 15
  elif n == 7:
    n_sens_bounds = [0.,80.]
    n_disc_bounds = [80., 201.]
    nstep_sens = 5
    nstep_disc = 15
elif catalog in ['SNR_cloud','SNR_PWN','SNR_noPWN']:
  n_sens_bounds = [0.,16.]
  n_disc_bounds = [16., 61.]
  nstep_sens = 2
  nstep_disc = 5
