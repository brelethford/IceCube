...
print("Using {}yrs of data".format(n))
print (sample)
...
# set up submitter
if catalog:
  jobdir = misc.ensure_dir ('/data/user/brelethford/Output/fast/stacking_sensitivity/{0}/{1}yr/jobs/'.format ( catalog, str(n)))
else:
...
commands, labels, = [], []
if catalog:
    opts_list = '{0} {1} --cat {2} --sindec {3}'.format (env_shell, job_script, catalog, sindec)
